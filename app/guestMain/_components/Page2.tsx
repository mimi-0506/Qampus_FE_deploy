...
export default function Page2() {
  return (
    <div className="flex aspect-[16/9] w-screen items-center justify-between">
      <div className="ml-[6vw] flex aspect-[764/160] w-[40vw] flex-col mx-auto items-start justify-between ">
        ...
        <div className="text-grey2 text-[1vw] leading-[1.4vw] mt-[1vw] tracking-[0.01vw]">
